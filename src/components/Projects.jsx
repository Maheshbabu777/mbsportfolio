        ...
        <div className="flex flex-col lg:flex-row gap-5 items-start">
          ...
          <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="group block p-7 border-2 border-[#ffffff]/30 rounded-[20px] hover:border-[#ffffff] transition-all duration-300 ease-out hover:scale-[1.03]">
              ...
              <img src={MultiTrans} alt="Multilingual Language Identification"
                className="h-full w-full rounded-lg object-cover grayscale-[0.8] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-500" />
            </div>
            ...
            <div className="group block p-7 border-2 border-[#ffffff]/30 rounded-[20px] hover:border-[#ffffff] transition-all duration-300 ease-out hover:scale-[1.03]">
              <div className="flex items-start justify-between gap-5">
                ...
                <a href="https://github.com/Maheshbabu777/Secure-Inter-process-Communication" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
                    className="w-4 h-4 text-white/30 group-hover:text-[#f8401a] group-hover:rotate-45 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300 shrink-0 mt-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
                  </svg>
              ...
              <p className="text-white text-base font-[400] leading-relaxed mb-5">
                Secure inter-process communication system in C with encryption and real-time visualization of process communication.
              </p>
              <img src={secure} alt="Secure IPC System"
                className="w-full h-full rounded-lg object-cover grayscale-[0.8] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-500" />
            </div>
          ...
          <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="group block p-7 border-2 border-[#ffffff]/30 rounded-[20px] hover:border-[#ffffff] transition-all duration-300 ease-out hover:scale-[1.03]">
              ...
              <p className="text-white text-base font-[400] leading-relaxed mb-5">
                Machine learning models to optimize EV charging behavior with 95.33% prediction accuracy.
              </p>
              <img src={Ev} alt="EV Battery Charging Optimization"
                className="w-auto h-auto rounded-lg object-cover grayscale-[0.8] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-500" />
            </div>
